...
// dryRun = true
// @CucumberOptions(features = "src/test/resources/features/Second.feature", glue = {"com.pritesh"},
// plugin = "html:target/selenium-reports")
@CucumberOptions(
  features = "src/test/resources/features/calculator/calculatorSum.feature",
  glue = {"com.pritesh"},
